...
@dp.callback_query_handler(years_callback.filter(item_name = 'amity_l_2019'))
...
@dp.callback_query_handler(years_callback.filter(item_name = 'amity_l_2020'))
async def buying_corse(call: CallbackQuery, callback_data: dict):
...
@dp.callback_query_handler(years_callback.filter(item_name = 'amity_l_2021'))
async def buying_corse(call: CallbackQuery, callback_data: dict):
